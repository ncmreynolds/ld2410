# 02 — Variants: LD2410 vs LD2410C vs LD2410S

The Hi-Link "LD2410" family is **three different sensors** sharing a
...
| Configurable Bluetooth + Android app | **LD2410C** (only variant with BT) |
...
The LD2410C is what most resellers ship as "LD2410" today. If your
...
| Distance resolution | fixed 0.75 m | switchable 0.75 / 0.20 m | not specified by HLK V1.00 — `detectionDistance()` reports cm directly |
| OUT pin position | pin **1** | pin **3** | pin **5 (J2)** |

> ⚠️ **Wiring danger:** the base and C variants have **opposite** OUT-pin
> layouts on a 5-pin header. A board labelled just "LD2410" can be
> either; check before connecting power, or you may feed 5 V into a
> 3.3 V data pin. Full pinout in
...
- Original HLK PDFs (translated from Chinese): [`HLK-LD2410_protocol.md`](HLK-LD2410_protocol.md), [`HLK-LD2410C_protocol.md`](HLK-LD2410C_protocol.md), [`HLK-LD2410S_protocol.md`](HLK-LD2410S_protocol.md)
